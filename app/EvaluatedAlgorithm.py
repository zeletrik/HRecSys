# -*- coding: utf-8 -*-
'''
Created on Mon Jun 17 14:18:14 2019
...
class EvaluatedAlgorithm:
    log = logging.getLogger('RecSys.EvaluatedAlgorithm')
    ...
    def Evaluate(self, evaluationData, doTopN, n=10, verbose=True):
        ...
        if (doTopN):
            ...
            # See how often we recommended a hotel the user actually rated
            metrics['HR'] = RecommenderMetrics.HitRate(topNPredicted, leftOutPredictions)   
            # See how often we recommended a hotel the user actually liked
